...
def buscar(request):
      if request.GET["nombre"]:
            ...
            tecnologias = Tecnologias.objects.filter(nombre__icontains=nombre)
            return render(request, "AppsServicios/lista_tecnologias.html", {'tecnologia': tecnologias})
      
      else:
        
        return render(request, "AppsServicios/lista_tecnologias.html", {'tecnologia':[]})
